...
// ../.wrangler/tmp/bundle-IEYbum/checked-fetch.js
  ...
  "adaptive_parameters": { "recommended_next_target": string, "next_curriculum_stage": string, "scaffolding_level": string, "cognitive_load_adjustment": string, "retrieval_practice_prompt": string }
    ...
    const aiResponse = await env.AI.run("@cf/meta/llama-3.2-11b-vision-instruct", {
      ...
      messages: [
        ...
        { role: "user", content: "Analyze the attached specimen." }
      ],
      image: [...binaryImage]
    });
    let assessment;
    ...
    return new Response(JSON.stringify({
      ...
      audio: audioBase64,
      location
      // Pass location back to frontend for HUD
    }), {
      headers: {
...
var onRequestPost2 = /* @__PURE__ */ __name(async (context) => {
  const { request, env } = context;
  const { subjectId, profile } = await request.json();
  if (!subjectId || !env.SUBJECT_ARCHIVE) {
...
// ../.wrangler/tmp/pages-KNF3jN/functionsRoutes-0.9323095763265399.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-IEYbum/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-IEYbum/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.0978500957719961.mjs.map
